# -*- coding: utf-8 -*-
"""
Created on Fri May 26 18:22:15 2017
...
class FeatureUnionExt(FeatureUnion):
    ...
    def __init__(self, transformer_list, idx_list, n_jobs=1, transformer_weights=None):
        ...
        FeatureUnion.__init__(self, 
                              transformer_list=map(lambda trans:(trans[0], trans[1]), transformer_list), 
                              n_jobs=n_jobs, 
    ...
    def fit_transform(self, X, y=None, **fit_params):
        ...
        result = Parallel(n_jobs=self.n_jobs)(
            ...
            delayed(_fit_transform_one)(trans, name, self.transformer_weights,
                                        X[:,idx], y,
                                        **fit_params)
            for name, trans, idx in transformer_idx_list)
...
grid_search = GridSearchCV(pipeline, 
                           param_grid={'FeatureUnionExt__ToBinary__threshold':[1.0, 2.0, 3.0, 4.0],
